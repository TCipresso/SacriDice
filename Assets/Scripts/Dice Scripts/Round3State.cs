...
public class Round3State : MonoBehaviour
{
    ...
    // OnClick order: 1) SacrificeManager2.CommitSelected  2) Round3_SacrificePressed
    public void Round3_SacrificePressed()
    {
        ...
        {
            Debug.LogWarning("[Round3] You need to select a sacrifice first.");
            return;
        }

        // Hide Round 3 UI immediately
